...
class ApiService {
  ...
  async adminNewsAIReviewPrompt(id: string, payload: { action: 'approve' | 'reject' | 'rebuild' | 'auto'; notes?: string }): Promise<any> { return (await this.client.patch(`/api/v1/admin/news/ai-prompts/${id}/review`, payload)).data; }
