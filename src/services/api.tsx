...
class ApiService {
  ...
  async adminNewsAIReviewPrompt(id: string, payload: { outcome: 'approved' | 'needs_revision'; notes?: string }): Promise<any> { return (await this.client.patch(`/api/v1/admin/news/ai-prompts/${id}/review`, payload)).data; }
